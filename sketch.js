//====================VARIABLES IN CODE======================
var input_sensors = 16;
const opLayer = 6;
var input_range = 150.0;
var networkArchitecture = [input_sensors,  24, 18, 12, 8, opLayer]; //output must always be 6!
var minWeightVal = -2;
var maxWeightVal = 2;
...
var mapFileName = 'testmap2.json';
var modelFileName = 'test2.json';
...
function draw() {
  ...
  if (pause)
    ...
    if(population.genCount < max_generations+1)
